...
agents/                 # ladder agents (deck + policy)
  ...
  alakazam_mist/        #   alakazam + Mist Energy mirror tech (defensive overlay vs Powerful Hand)
...
tools/cabt_ab.py        # A/B two of our agent dirs against each other in the cabt env
